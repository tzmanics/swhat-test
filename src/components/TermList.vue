    ...
    <div class='term-box'>
      <div class='term'>
        ...
        <div class='term-pronunciations'>
          ...
          <kendo-button
            icon='volume-up'
            @click="playSound('https://drive.google.com/uc?export=download&id=1dRwHJ8GB8iKlWVpI4cbOE_tO4P1-eNA3')"
          > ˈɡɪf
          </kendo-button>
          <input
            type='radio'
          ...
          <kendo-button
            ...
            :value='1'
            v-model='selected'
            @click='playSound("https://drive.google.com/uc?export=download&id=1o-qR5Wj-mVsLv_u6jItW-1tQmcywgtlU")'
          > /jif/
          </kendo-button>
        </div>
...
export default {
  ...
  methods: {
    ...
    onVote () {
      ...
      console.log('1: %s, 2: %s', this.pronunciation1Votes, this.pronunciation2Votes)
    }
  }
}
</script>
